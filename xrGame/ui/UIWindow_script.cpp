...
//				value("SLEEP_WND_PERFORM_BUTTON_CLICKED",			int(SLEEP_WND_PERFORM_BUTTON_CLICKED)),
	...
	// CUIInventroyWnd
				...
				value("INVENTORY_EAT2_ACTION",						int(INVENTORY_EAT2_ACTION)),
				value("INVENTORY_EAT3_ACTION",						int(INVENTORY_EAT3_ACTION)),
				value("INVENTORY_EAT4_ACTION",						int(INVENTORY_EAT4_ACTION)),
				value("INVENTORY_EAT5_ACTION",						int(INVENTORY_EAT5_ACTION)),
				value("INVENTORY_EAT6_ACTION",						int(INVENTORY_EAT6_ACTION)),
				value("INVENTORY_EAT7_ACTION",						int(INVENTORY_EAT7_ACTION)),
				value("INVENTORY_EAT8_ACTION",						int(INVENTORY_EAT8_ACTION)),
				value("INVENTORY_EAT9_ACTION",						int(INVENTORY_EAT9_ACTION)),
